 ...
 * GET     /api/schools/:id          ->  show
 * PUT     /api/schools/:id          ->  upsert
 * PATCH   /api/schools/:id          ->  patch
 * DELETE  /api/schools/:id          ->  destroy
 */
...
// Upserts the given School in the DB at the specified ID
export function upsert(req, res) {
  if(req.body._id) {
    Reflect.deleteProperty(req.body, '_id');
  }
  return School.findOneAndUpdate({_id: req.params.id}, req.body, {new: true, upsert: true, setDefaultsOnInsert: true, runValidators: true}).exec()
